...
local function ThreadTick()
	if TimersNotify[os.date("%H:%M")] then
		TriggerClientEvent("Notify",-1,"Queda de Aeronave","A torre de controle recebeu a informação que uma <b>Aeronave</b> está com problemas mecânicos e está em queda livre, parece que em <b>5 minutos</b> a mesma vai colidir com o solo.","azul",30000)
	end
	...
	if Timers[os.date("%H:%M")] and not GlobalState["Helicrash"] then
		...
		TriggerClientEvent("Notify",-1,"Queda de Aeronave","Mayday! Mayday! Tivemos problemas técnicos em nossos motores e estamos em queda livre.","azul",30000)
