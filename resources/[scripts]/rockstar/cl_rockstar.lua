-- [[ Initialize Menu ]] --
local menu = MenuV:CreateMenu(false, 'Editor Rockstar', 'topleft', 52, 180, 235, 'size-125', 'none', 'menuv', 'example_namespace')
slider = menu:AddSlider({ icon = '🎥', label = 'Opção', value = 'option', values = {
